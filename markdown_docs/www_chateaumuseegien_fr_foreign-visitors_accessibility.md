# https://www.chateaumuseegien.fr/foreign-visitors/accessibility/#top
...
! Reception with hearing impaired loop

Reception with hearing impaired loop 
! Lift serving all levels

Lift serving all levels 
! Guide dogs are the only dogs allowed in the museum

Guide dogs are the only dogs allowed in the museum 
! Car park for disabled persons along the church

Car park for disabled persons along the church 
Reduced rates are proposed for disabled persons.
## More informations 
 * Prepare your visit

 * Car park for disabled persons along the church (about 100 m from the main access of the museum) 
 * Drop-off possible in front of the main access of the museum.
 * Reception with hearing impaired loop.
 * A French guide book using the Easy to Read and Understand method can be borrowed for visitors with intellectual disability. 
 * A magnifying glass can be borrowed to ease the reading of explanatory texts of the museum. 
 * A wheelchair and "cane sits" can be borrowed at reception on simple request.
 * Benches and stools all along the visit.
 * Lift serving all levels.
 * Guide dogs are the only dogs allowed in the museum

## The virtual visit of the museum is available 
 * Some narrow doors prevent the access of some museum spaces with en electric wheelchair.
 * Special attention may be required with some slopes.

## For any question about accessibility 
 * 02 38 29 81 46
